...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, ledA_Pin|ledS_Pin|ledD_Pin|ledF_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : ledA_Pin ledS_Pin ledD_Pin ledF_Pin */
  GPIO_InitStruct.Pin = ledA_Pin|ledS_Pin|ledD_Pin|ledF_Pin;
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart){
	...
	if(command[0]== 'a'){
				  ...
				  HAL_GPIO_WritePin(ledS_GPIO_Port, ledS_Pin, 0);
